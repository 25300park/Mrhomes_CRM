...
test('offline timer remains visible and reconnect reconciles a newer authoritative timer', async ({ page, context }) => {
  ...
  const newerServerStart = new Date(Date.now() + 60_000).toISOString()
  await fixture.setServerTimer({ id: '50000000-0000-4000-8000-000000000099', standard_category_id: '20000000-0000-4000-8000-000000000002', started_at: newerServerStart, linked_entity_type: null, linked_entity_id: null, linked_entity_label: null })
